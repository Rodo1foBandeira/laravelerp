    ...
    */
    ...
    Grid.defaults = {
        ...
        formatters: {
            ...
            {
                return
                    '<a href="'+window.location.href+'/'+row.id+'/edit" class="btn btn-warning btn-xs pull-left">' +
                        '<span class="glyphicon glyphicon-pencil"></span>' +
                    '</a>' +
                    '<form method="POST" action="'+window.location.href+'/'+row.id+'" accept-charset="UTF-8" onsubmit="return confirm(&quot;Deseja realmente excluir?&quot;);">' +
                        '<input name="_method" type="hidden" value="DELETE">' +
                        '<input name="_token" type="hidden" value="'+document.head.querySelector("[name=csrf-token]").content+'">' +
